  ...
  return (
    <Fragment>
      <Head>
        ...
        {pageProps?.pageHead?.description && (<meta name="description" content={pageProps.pageHead.description} />)}
        {pageProps?.pageHead?.keywords && (<meta name="keywords" content={pageProps?.pageHead?.keywords} />)}
      </Head>
      <Providers {...pageProps}>
